    ...
    <Container>
      <article class="min-w-0">
        <MarkdownContentRender
          postId={props.post.metadata.postId}
  ...
  return (
    <>
      ...
      <div class="my-10 flex flex-col gap-7">
        <BlogPostHeader post={props.post} />
...
const BlogPostHeader: Component<BlogPostRenderProps> = (props) => {
  return (
...
const BlogPostThumbnailPlaceholder: Component<BlogPostRenderProps> = (
  ...
  return (
    <div class="relative h-62 from-transparent to-background-80 bg-linear-to-b lg:bg-linear-to-r">
