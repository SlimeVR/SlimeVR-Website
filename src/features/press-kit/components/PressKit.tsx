  ...
  <PressKitSection title="About Us">
    <div>
      ...
      <PressKitBulletList
        items={[
          <>
            The SlimeVR ecosystem is a set consisting of open hardware sensors
            and an open-source server that facilitates{" "}
    ...
    <div class="gap-3">
      ...
      <div>
        <Typography tag="p">
          The SlimeVR ecosystem consists of a set of trackers and server
          software that let users track their body movements and pose; from the
          torso and hips, to the fingers and toes.
        </Typography>
        <Typography tag="p">
          This lets users bring their real-life movements into VR, do VTubing,
          and perform motion capture.
        </Typography>
        <Typography tag="p">
          SlimeVR trackers are based on IMUs which do not require base stations
          or cameras, completely avoiding occlusion issues - you can use them
      ...
      <div class="mt-2">
        ...
        <PressKitBulletList
          items={[
            <>
              <strong>Games</strong> that supports FBT via SteamVR, OSC, or VMC
              are compatible with SlimeVR: VRChat, NeosVR, Blade and Sorcery,
              Dance Dash, Zenith: Nexus, Chillout VR, Resonite, LIV and many
              others!
            </>,
            <>
              <strong>VTubing</strong> software that supports OSC, VMC
              protocols, or SteamVR support SlimeVR, including VSeeFace, Warudo,
              Tracking Worlds, and many more!
            </>,
            <>
              <strong>Motion Capture (MoCap)</strong> software that can import
              BVH files, or works with OSC, VMC protocols, and SteamVR,
              including Blender, Unreal Engine, and more!
            </>,
          ]}
        />
      </div>
