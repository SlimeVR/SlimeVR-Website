...
description: "Hiyo slime gang~! Spazzwan <img src=\"/blog/emoji/SKC_SpazzwanLogo-1369048981102919742.webp\" alt=\"SKC_SpazzwanLogo\" class=\"discord-emoji\" /> here, with a rather late but still great update for you t..."
thumbnailUrl: "/blog/posts/weekly-update-228/89959_1785152026682_166.webp"
---

Hiyo slime gang~! Spazzwan <img src="/blog/emoji/SKC_SpazzwanLogo-1369048981102919742.webp" alt="SKC_SpazzwanLogo" class="discord-emoji" /> here, with a rather late but still great update for you to enjoy! <3
**Shipment 15.1:**
This shipment has officially arrived into Crowd Supply custody and is expected to begin shipping out to customers once processing is finished in a few days. Weighing in over 2 metric tonnes, it contains over 3,000 sets of slimes including **Lower-Body**, **Enhanced Core**, **Full-Body**, and **Deluxe** sets, as well as lots of **Hip** and **Feet** set upgrades that many of you have been waiting for. Those of you in this shipment, please keep a close eye on your inboxes and check your order status over the next two weeks to ensure a smooth delivery.

**Shipment 16:**
Now with the combined might of 15.2, this shipment will once again be moderately sized. Set to finish assembly in around 2 weeks from now, this will contain a plethora of sets, including Core, Enhanced core, DIY, and a bunch more upgrades. Those hanging out for a Core set, Elbow set upgrade, or DIY set in particular should keep a close eye on the progress of this one, as this will be the next shipment containing those three SKUs. We are predicting this shipment arrival at CS around the **second half of March**.
...
## Merch News <img src="/blog/emoji/nighty_hug-1314209493747241011.webp" alt="nighty_hug" class="discord-emoji" />
