...
Hiyo slime gang~! Head cat Spazzwan<img src="/public/blog/emoji/SKC_SpazzwanLogo-1369048981102919742.webp" alt="SKC_SpazzwanLogo" class="discord-emoji" /> here, with another hot update set to toast up your IMU's for maximum performance!
## Shipment update <img src="/public/blog/emoji/nighty_nom-1314209503276699708.webp" alt="nighty_nom" class="discord-emoji" />
**Shipment 15:**
Done... basically. I've seen a trickle of orders arriving here and there, but for all intents and purposes s15 is done so this is the last I'll mention it in updates.
**Shipment 15.1:**
Shipment 15.1 is basically ready to launch, and is just receiving its final touches while it waits for pickup sometime early this week. After it has been picked up by UPS from our cave in NL, I am expecting a similar timeframe of around 15-20 days for it to arrive at Crowd Supply. As such, we are expecting this to arrive at CS around the first week of **February**.
Most sets are sold out in this shipment, I believe there are only low numbers of 6+2 left.
**Shipment 16:**
This shipment will restock most sets that are sold out currently. We have this tentatively slated for early march, and will include a huge number of all the sets, in particular over 2000 of the ever-popular Core (6+0) sets in addition to lots of upgrades people have been patiently waiting for. Assembly on this continues this week, and we are expecting stock to be ready and shipped late February, with it arriving at CS sometime in **March**.

To sum up the current sets and when they are next expected:
**6+2**, **8+2**, **DIY**, __upgrades__ **-** S15.1 (early Feb)
**5+0**, **6+0**, 6+2, 8+2, **12+4**, DIY, **upgrades** **-** S16 (estimated early to mid March)

-# __Note__: Upgrades in s15.1 are likely sold out, as they are backlogged to 07/2025

Cross reference the expected dates for each shipment with your Crowdsupply estimate to find out which shipment your order falls under.
...
SlimeVR will be presenting on the second day, [Feb 1, 2026, 10:25-10:50 in the 'Gaming and VR devroom'](https://fosdem.org/2026/schedule/event/TBFSCP-slimevr/), so if you want to see us specifically that's the day! Come share your love for SlimeVR or tune in to ask some questions in the chat room!
