...
**Shipment 16:**
Making its debut this update, Shipment 16 is set to begin assembly this week. We have this tentatively slated for late feb/early march, and will include a huge number of all the sets, in particular over 2000 of the ever-popular Core (6+0) sets.

**To sum up the current sets and when they are next expected to arrive at CS:**
~~5+0 - In stock at CS *(not sure how many are left or how long these will last)*~~
6+2, 8+2, DIY, upgrades - **S15.1** *(late jan/early feb)*
**5+0**, **6+0**, 6+2, 12+4, DIY, upgrades - **S16** *(estimated late feb/early march)*

Please note these dates and stock levels can change after I post this at any time.
...
![attachment](assets/Butterfly-News/1-b2.png)
...
![attachment](assets/Rapid-Roundup/1-c1.jpg)
![attachment](assets/Rapid-Roundup/2-c3.jpg)
![attachment](assets/Rapid-Roundup/3-c4.jpg)
![attachment](assets/Rapid-Roundup/4-c5.jpg)
![attachment](assets/Rapid-Roundup/5-c6.jpg)
![attachment](assets/Rapid-Roundup/6-c7.jpg)
![attachment](assets/Rapid-Roundup/7-c10.png)
